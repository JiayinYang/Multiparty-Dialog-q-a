...
class CNN_LSTM_UA_DA_Model(BaseModel):
    ...
    def build_model(self):
        ...
        con = Convolution2D(self.nb_filters_query, (1, self.embedding_size), activation='relu')(conv_embedding_query)
        ...
        for i in range(self.nb_utterances):
            ...
            for j in range(2, 6):
                ...
                pool = MaxPooling2D(pool_size=(self.nb_utterance_token-j+1, 1))(conv_u)
...
class DocAttentionMap(Layer):
    ...
    def call(self, x, **kwargs):
        ...
        print('dot    : %s' % str(K.dot(x, self.U)))
